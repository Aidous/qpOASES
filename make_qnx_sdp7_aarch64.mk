...
##
##	Filename:  make_qnx_sdp7_aarch64.mk (based on make_linux.mk)
##	Author:    Jilin Zhou
##	Version:   3.2
##	Date:      2007-2017
##
...
CPPFLAGS = -Wall -pedantic -Wshadow -Wfloat-equal -O3 -Wconversion -Wsign-conversion -fPIC -D__QNXNTO__ -D${DEF_SOLVER} -D__NO_COPYRIGHT__
